    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          ...
          <div class="position-absolute top-50 start-50 translate-middle mb-5 " style="background-color:rgb(251,208,121,1);text-align:inherit;width:max-content">
        ...
        <div class="carousel-item">
          ...
          <!--moved the text to the middle of an image or banner -->
          <div class="position-absolute top-50 start-50 translate-middle mb-5" style="background-color:rgb(251,208,121,1);width:max-content;border-radius:2%">
            <span class="bannertxt">For Those Timeless Moments!.</span>
            <br>
          </div>
        </div>
      </div>
