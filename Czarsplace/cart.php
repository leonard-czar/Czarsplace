...
?>
<?php
if (isset($_REQUEST['quantity']) && $_REQUEST['cart_id']) {
}
    ...
    <div class="row justify-content-center text-center">
        <div class="col-sm">
           ...
           if (isset($_REQUEST['yes'])) {
                    $yes = $_REQUEST['yes'];
                    echo "<div class='alert alert-success mt-1  mb-1 col-sm' style='text-align:center;font-family: czars2;'>$yes</div>";
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="editcartitem.php" method="post" class="">
                                        <input type="hidden" name="cartid" value="<?php echo  $value['cartid'] ?>">
                                        <input type="hidden" name="cartqty" value="<?php echo  $value['qty'] ?>">
    ...
    <div class="row mb-5 justify-content-center">
        ...
        <div class="col-6 text-center" style="margin-right: 40px;">
            <b>
                    ...
                    <div>
                        <input type="text" value="<?php echo array_sum($totals); ?>" name="total" class="text-center" disabled style="color:black">
                    </div>
            </b>
        </div>
    </div>
