            ...
            <ul class="navbar-nav mb-sm-2 col-sm">
              ...
              <li class="nav-item dropdown !important col-sm">
                ...
                <ul id="drop" class="dropdown-menu" style="font-size: 1vw; color:rgba(0, 0, 0)!important;">
                  <li>
                    <a class="dropdown-item" href="audemarsdash.php" id="aplink">Audemars Piguet</a>
                  </li>
                  <li><a class="dropdown-item" href="rolexdash.php">Rolex</a></li>
                  <li><a class="dropdown-item" href="hublotdash.php">Hublot</a></li>
                </ul>
              </li>
