        ...
        <nav class="navbar navbar-expand navbar-light">
          <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav mb-sm-2 col-sm">
              ...
              <li class="nav-item dropdown !important col-sm">
                <a class="nav-link dropdown-toggle " href="#" style="color:rgba(255, 255, 255,0.5);
                        font-size: 1.1vw!important;" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="true">
                  <b>BRANDS</b>
                </a>
                <ul id="drop" class="dropdown-menu" style="font-size: 1vw; color:rgba(0, 0, 0)!important;">
                  <li>
                    <a class="dropdown-item" href="index_audemars.php" id="aplink">Audemars Piguet</a>
                  </li>
                  <li><a class="dropdown-item" href="index_rolex.php">Rolex</a></li>
                  <li><a class="dropdown-item" href="index_hublot.php">Hublot</a></li>
                </ul>
              </li>
