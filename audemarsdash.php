...
$audemarsobj = new Customer();
$audemars = $audemarsobj->getallaudemars();
$brandobj = new Customer();
$brandap = $brandobj->getbrandap();
...
<div class='row'>
  <div class="col-sm " style="text-align:center">
    <?php
    ?>
    <img src="images/<?php echo $brandap['brand_image']; ?>" width="100" alt="" class="img-fluid" id="Audemars">
    <?php
    ?>
  </div>
</div>
  ...
  ?>
      <div class="col-sm-3 p-sm-3">
        ...
        <form action="watchspec.php" method="post" style="text-align: center;">
          ...
          <input type="hidden" value="<?php echo $brandap['brand_name']; ?>" name="brandname">
